        ...
        <div class="flex flex-col box box--stacked">
            ...
            <div class="overflow-auto xl:overflow-visible">
                <Table class="border-b border-slate-200/60">
                    ...
                    <Table.Tbody>
                        <template v-for="(faker, fakerKey) in _.take(users.fakeUsers(), 10)" :key="fakerKey">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-9 h-9 image-fit zoom-in">
                                            <Tippy as="img" alt="Tailwise - Admin Dashboard Template"
                                                ...
                                                :src="faker.photo" :content="faker.name" />
                                        </div>
                                        <div class="ml-3.5">
    ...
    <div class="mb-4 flex justify-between items-center gap-4">
      ...
      <div class="ml-auto flex gap-2">
        <button
          ...
          class="p-2 border rounded bg-gray-100 hover:bg-gray-200"
        >CSV</button>
        <button
        ...
        <button
          ...
          class="p-2 border rounded text-white bg-red-600 hover:bg-red-700"
        >
          Delete Selected
        </button>
      </div>
