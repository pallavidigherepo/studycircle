  ...
  new MarkerClusterer(
    ...
    location.map(function (markerElem) {
      ...
      const marker = new google.maps.Marker({
        ...
        icon: {
          url: !darkMode.value
            ? imageAssets["/assets/images/map-marker.svg"].default
            : imageAssets["/assets/images/map-marker-dark.svg"].default,
        },
      });
      ...
      styles: [
        {
          ...
          textColor: "white",
          url: !darkMode.value
            ? imageAssets["/assets/images/map-marker-region.svg"].default
            : imageAssets["/assets/images/map-marker-region-dark.svg"]
                .default,
          anchor: [0, 0],
          anchorText: [17, 0],
          fontWeight: "bold",
