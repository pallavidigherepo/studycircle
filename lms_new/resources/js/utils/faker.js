...
const fakers = {
  ...
  fakePhotos() {
    ...
    for (let i = 0; i < 15; i++) {
      photos[photos.length] =
        imageAssets[
          "/assets/images/profile-" + _.random(1, 15) + ".jpg"
        ].default;
    }
  ...
  fakeImages() {
    ...
    for (let i = 0; i < 15; i++) {
      images[images.length] =
        imageAssets[
          "/assets/images/preview-" + _.random(1, 15) + ".jpg"
        ].default;
    }
  ...
  fakeFoods() {
    const foods = [
      {
        name: "Vanilla Latte",
        image: imageAssets["/assets/images/food-beverage-1.jpg"].default,
      },
      {
        name: "Milkshake",
        image: imageAssets["/assets/images/food-beverage-2.jpg"].default,
      },
      {
        name: "Soft Drink",
        image: imageAssets["/assets/images/food-beverage-3.jpg"].default,
      },
      {
        name: "Root Beer",
        image: imageAssets["/assets/images/food-beverage-4.jpg"].default,
      },
      {
        name: "Pocari",
        image: imageAssets["/assets/images/food-beverage-5.jpg"].default,
      },
      {
        name: "Ultimate Burger",
        image: imageAssets["/assets/images/food-beverage-6.jpg"].default,
      },
      {
        name: "Hotdog",
        image: imageAssets["/assets/images/food-beverage-7.jpg"].default,
      },
      {
        name: "Avocado Burger",
        image: imageAssets["/assets/images/food-beverage-8.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Beef Bacon",
        image: imageAssets["/assets/images/food-beverage-9.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Smoked Salmon",
        image: imageAssets["/assets/images/food-beverage-10.jpg"].default,
      },
      {
        name: "Curry Penne and Cheese",
        image: imageAssets["/assets/images/food-beverage-11.jpg"].default,
      },
      {
        name: "French Fries",
        image: imageAssets["/assets/images/food-beverage-12.jpg"].default,
      },
      {
        name: "Virginia Cheese Fries",
        image: imageAssets["/assets/images/food-beverage-13.jpg"].default,
      },
      {
        name: "Virginia Cheese Wedges",
        image: imageAssets["/assets/images/food-beverage-14.jpg"].default,
      },
      {
        name: "Fried/Grilled Banana",
        image: imageAssets["/assets/images/food-beverage-15.jpg"].default,
      },
      {
        name: "Crispy Mushroom",
        image: imageAssets["/assets/images/food-beverage-16.jpg"].default,
      },
      {
        name: "Fried Calamari",
