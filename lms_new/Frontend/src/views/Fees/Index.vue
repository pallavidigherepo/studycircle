                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-auto flex w-40">
                                                        <template v-if="transactionModel.payment_method === 'cheque'">
                                                            <FormInput placeholder="Enter cheque number" type="text"
                                                                   class="form-control" v-model="transactionModel.uid"/>
                                                        </template>
                                                        <template v-if="transactionModel.payment_method === 'upi'">
                                                            <FormInput placeholder="Enter transaction number" type="text"
                                                                   class="form-control" v-model="transactionModel.uid"/>
                                                        </template>
                                                ...
                                                <Table class="table striped">
                                                    ...
                                                    <template v-if="studentFeeStructure">
                                                        ...
                                                        >
                                                            ...
                                                            <Table.Td class="text-right">{{ feeStructure.amount }}</Table.Td>
                                            ...
                                            <div class="grid grid-cols-12 gap-6 mt-2">
                                                ...
                                                <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
                                                    <Table class="table table-report -mt-2">
                                                        <Table.Thead>
                                                        <Table.Tr>
                                                            <Table.Th class="whitespace-nowrap">INVOICE</Table.Th>
                                                            <Table.Th class="whitespace-nowrap">AMOUNT</Table.Th>
                                                            <Table.Th class="whitespace-nowrap">PAYMENT METHOD</Table.Th>
                                                            <Table.Th class="whitespace-nowrap">UID</Table.Th>
                                                            <Table.Th class="whitespace-nowrap">PAID ON</Table.Th>
                                                            <Table.Th class="whitespace-nowrap">ACTIONS</Table.Th>
                                                        </Table.Tr>
                                                        </Table.Thead>
                                                        <Table.Tbody>
                                                        <Table.Tr v-for="(transaction, id) in studentFeeTransactions.data" :key="id">
                                                            <Table.Td class="whitespace-nowrap">#{{ transaction.id }}</Table.Td>
                                                            <Table.Td class="whitespace-nowrap">{{ transaction.amount }}</Table.Td>
                                                            <Table.Td class="whitespace-nowrap">{{ transaction.method}}</Table.Td>
                                                            <Table.Td class="whitespace-nowrap">{{ transaction.uid ? transaction.uid: '-' }}</Table.Td>
                                                            <Table.Td class="whitespace-nowrap">{{ transaction.created_on}}</Table.Td>
