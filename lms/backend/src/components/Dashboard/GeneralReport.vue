<template>
    ...
    <div class="col-span-12 mt-8">
        <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">{{ t("dashboard.General Report") }}</h2>
            <router-link :to="{name: 'Dashboard'}" class="ml-auto flex items-center text-primary">
                <RefreshCcwIcon class="w-4 h-4 mr-3" />
                {{ t("dashboard.Reload Data") }}
            </router-link>
        </div>
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                <div class="report-box zoom-in">
                    <div class="box p-5">
                        <router-link to="/fees">
                            <div class="flex">
                                <DollarSignIcon class="report-box__icon text-warning" />
                                <div class="ml-auto">
                                    <Tippy
                                        tag="div"
                                        class="report-box__indicator bg-success cursor-pointer"
