...
const treemapChartData = treemapChart;
const multiSeriesChartData = multiSeriesChart;
const distributedChartData = distributedChart;
const colorRangeChartData = colorRangeChart;
</script>
