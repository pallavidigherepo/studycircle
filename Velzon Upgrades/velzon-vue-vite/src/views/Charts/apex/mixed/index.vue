...
// Just define reactive refs or plain constants for your chart data
const mixedLineChartData = mixedLineChart;
const yAxisChartData = yAxisChart;
const lineAreaChartData = lineAreaChart;
const lineColumnAreaChartData = lineColumnAreaChart;
</script>
