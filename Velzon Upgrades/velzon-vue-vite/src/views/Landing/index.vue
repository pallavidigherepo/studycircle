...
function showMonthly() {
  document.querySelectorAll(".month").forEach(item => item.style.display = "block");
  document.querySelectorAll(".annual").forEach(item => item.style.display = "none");
}

function showAnnually() {
  document.querySelectorAll(".month").forEach(item => item.style.display = "none");
  document.querySelectorAll(".annual").forEach(item => item.style.display = "block");
}
...
onMounted(async () => {
  ...
  if (planSwitch) {
    planSwitch.addEventListener('change', () => {
      if (planSwitch.checked) showAnnually();
      else showMonthly();
    });
  }
  ...
  if (yearEl) {
    yearEl.innerHTML = new Date().getFullYear() + " © Velzon - Themesbrand";
  }
});
