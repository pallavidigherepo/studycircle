...
const defaultOptions4 = ref({
    animationData: animationData4
});
const defaultOptions5 = ref({
...
const modalShow11 = ref(false);
const modalShow12 = ref(false);
const modalShow13 = ref(false);
const modalShow14 = ref(false);
const modalShow15 = ref(false);
const modalShow16 = ref(false);
const modalShow17 = ref(false);
const modalShow18 = ref(false);
const modalShow19 = ref(false);
const modalShow20 = ref(false);
const modalShow21 = ref(false);
const modalShow22 = ref(false);
const modalShow23 = ref(false);
const modalShow24 = ref(false);
const modalShow25 = ref(false);
const modalShow26 = ref(false);
const modalShow27 = ref(false);
const modalShow28 = ref(false);
const modalShow29 = ref(false);
const modalShow30 = ref(false);
const modalShow31 = ref(false);

const changecustomerName = (e) => {
    const msg = document.querySelector(".varyingcontentModal");
    const customerName = document.getElementById("customer-name");
    modalShow6.value = !modalShow6.value;
    msg.innerText = "New message to " + e;
    customerName.value = e;
};

const toggleModal = () => {
    modalShow30.value = !modalShow30.value;
    modalShow31.value = !modalShow31.value;
};
</script>
                ...
                <BRow>
                    ...
                    <BCol xl="4" md="6">
                        ...
                        <BModal v-model="modalShow29" hide-footer body-class="p-0" header-class="p-3"
                            ...
                            <BAlert variant="success" class="rounded-0 mb-0" show>
