...
const date7 = ref(null);
const date9 = ref(null);
const date10 = ref(null);
const time = ref(null);
...
onMounted(() => {
  ...
  document.querySelectorAll(".monolith-colorpicker").forEach(() => {
    Pickr.create({
  ...
  // Nano color picker
  document.querySelectorAll(".nano-colorpicker").forEach(() => {
    Pickr.create({
      el: ".nano-colorpicker",
      theme: "nano",
      default: "#3577f1",
  ...
  // Demo color picker
  document.querySelectorAll(".colorpicker-demo").forEach(() => {
    Pickr.create({
      el: ".colorpicker-demo",
      theme: "monolith",
      default: "#405189",
  ...
  // Opacity & Hue color picker
  document.querySelectorAll(".colorpicker-opacity-hue").forEach(() => {
    Pickr.create({
  ...
  document.querySelectorAll(".colorpicker-swatches").forEach(() => {
    Pickr.create({
  ...
  // Input color picker
  document.querySelectorAll(".colorpicker-input").forEach(() => {
    Pickr.create({
  ...
  // Format color picker
  document.querySelectorAll(".colorpicker-format").forEach(() => {
    Pickr.create({
              ...
              <BRow>
                <BCol lg="6">
                  <div class="mt-3">
                    ...
                    <flat-pickr v-model="date10" :config="defaultDateConfig" class="form-control flatpickr-input"></flat-pickr>
                  </div>
                </BCol>
                <BCol lg="6">
                  <div class="mt-3">
