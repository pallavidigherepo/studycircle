...
const countrylist = [
  ...
  toggles.value[country.id] = true
})

// Dropdown and input flags state
const simpleDrop = ref(false)
const simpleDropValue = ref("")

const inputFlagDrop = ref(false)
const inputFlagDropValue = ref(countrylist[0]) // replace with your `sampleCountryData`

const simpleMenu = ref(false)
const simpleMenuValue = ref("")

const inputFlagNumber = ref(false)
const inputFlagNumberValue = ref(countrylist[0]) // replace with your `sampleCountryData`

const inputFlag = ref(false)
const inputFlagValue = ref(countrylist[0]) // replace with your `sampleCountryData`
  ...
  document.querySelectorAll(".form-label").forEach((item) => {
    document.addEventListener("click", function (event) {
      if (!item.nextSibling.contains(event.target)) {
        const dropdown = item.closest("div").querySelector(".dropdown-menu")
                ...
                <BCol sm="6">
                  <div>
                    ...
                    <div class="input-step">
                      <BButton variant="text-muted" class="minus">–</BButton>
                      <input type="number" class="product-quantity" value="2" min="0" max="100" readonly />
                      <BButton variant="text-muted" class="plus">+</BButton>
                    </div>
                  </div>
                </BCol>
              ...
              <BRow class="mt-4 pt-2">
                ...
                <div class="d-flex flex-wrap align-items-start gap-2">
                  <div class="input-step step-primary">
                    <BButton variant="primary" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="6" min="0" max="100" readonly />
                    <BButton variant="primary" class="plus">+</BButton>
                  </div>
                  <div class="input-step step-secondary">
                    <BButton variant="secondary" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="1" min="0" max="100" readonly />
                    <BButton variant="secondary" class="plus">+</BButton>
                  </div>
                  <div class="input-step step-success">
                    <BButton variant="success" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="3" min="0" max="100" readonly />
                    <BButton variant="success" class="plus">+</BButton>
                  </div>
                  <div class="input-step step-info">
                    <BButton variant="info" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="1" min="0" max="100" readonly />
                    <BButton variant="info" class="plus">+</BButton>
                  </div>
                  <div class="input-step step-warning">
                    <BButton variant="warning" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="4" min="0" max="100" readonly />
                    <BButton variant="warning" class="plus">+</BButton>
                  </div>
                  <div class="input-step step-danger">
                    <BButton variant="danger" class="minus">–</BButton>
                    <input type="number" class="product-quantity" value="5" min="0" max="100" readonly />
                    <BButton variant="danger" class="plus">+</BButton>
                  </div>
                </div>
              </BRow>
            </div>
