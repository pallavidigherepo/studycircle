...
const projectListWidgets1 = ref(projectWidgets1);
const projectListWidgets2 = ref(projectWidgets2);
const projectListWidgets3 = ref(projectWidgets3);

// Toggle favourite status using a CSS class
const toggleFavourite = (e) => {
  e.target.closest(".favourite-btn")?.classList.toggle("active");
};

// Handle project removal via modal and DOM manipulation
const removeProject = () => {
