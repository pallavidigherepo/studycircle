...
import { market as marketData } from '@/common/data'
...
const cryptoSlider = ref([
{
        ...
        {
          id: 4,
          img: "@/assets/images/svg/crypto-icons/bnb.svg",
          label: "Binance",
          price: "$1,820,045",
          change: "-09.21%",
          changeClass: "danger",
        ...
        {
          id: 6,
          img: "@/assets/images/svg/crypto-icons/usdt.svg",
          label: "Tether",
          price: "$5,201,458",
          change: "+14.99%",
          changeClass: "success",
...
// Methods
const setPages = () => {
  const numberOfPages = Math.ceil(market.value.length / perPage.value)
  pages.value = []
...
const onSort = (column) => {
  ...
  const sorted = [...market.value].sort((a, b) => {
