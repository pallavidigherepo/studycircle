...
// Defining options as reactive refs
...
const defaultOptions6 = ref({
  animationData: animationData6
});
const defaultOptions7 = ref({
  animationData: animationData7
});
const defaultOptions8 = ref({
  animationData: animationData8
});
const defaultOptions9 = ref({
  animationData: animationData9
});
const defaultOptions10 = ref({
  animationData: animationData10
});
const defaultOptions11 = ref({
  animationData: animationData11
});
const defaultOptions12 = ref({
  animationData: animationData12
});
const defaultOptions13 = ref({
  animationData: animationData13
});
const defaultOptions14 = ref({
