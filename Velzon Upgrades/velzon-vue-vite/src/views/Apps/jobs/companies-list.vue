...
const pages = ref([]);
const companies = ref(companiesList);
...
// Methods
const setPages = () => {
  let numberOfPages = Math.ceil(companies.value.length / perPage.value);
  pages.value = [];
