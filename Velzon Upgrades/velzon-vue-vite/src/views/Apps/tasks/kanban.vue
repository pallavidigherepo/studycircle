...
import {
  unassigned as unassignedData,
  todo as todoData,
  inprogress as inprogressData,
  reviews as reviewsData,
  completed as completedData,
  newData as newTaskData,
} from "@/common/data";
...
const unassigned = ref(unassignedData);
const todo = ref(todoData);
const inprogress = ref(inprogressData);
const reviews = ref(reviewsData);
const completed = ref(completedData);
const newData = ref(newTaskData);
