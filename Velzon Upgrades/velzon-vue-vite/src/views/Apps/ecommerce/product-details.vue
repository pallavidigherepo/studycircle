...
// Data
const productDetailsWidgets = ref([
  { id: 1, icon: "ri-money-dollar-circle-fill", label: "Price", labelDetail: "$120.40" },
  { id: 2, icon: "ri-file-copy-2-fill", label: "No. of Orders", labelDetail: "2,234" },
  { id: 3, icon: "ri-stack-fill", label: "Available Stocks", labelDetail: "1,230" },
  { id: 4, icon: "ri-inbox-archive-fill", label: "Total Revenue", labelDetail: "$60,645" }
]);
...
// Computed
const layoutType = computed(() => layoutComputed);
