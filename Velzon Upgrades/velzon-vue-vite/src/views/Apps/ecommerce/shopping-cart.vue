...
const deleteProduct = () => {
  ...
  if (removeItemModalElement) {
    removeItemModalElement.addEventListener("click", (e) => {
  ...
  if (plus) {
    Array.prototype.forEach.call(plus, (e) => {
      e.addEventListener("click", (event) => {
        const par = event.target.closest(".input-step");
...
const updateQuantity = (quantityInput) => {
  ...
  let price;
  Array.prototype.forEach.call(productRow.getElementsByClassName("product-price"), (e) => {
    price = parseFloat(e.innerHTML);
  });

  if (
    quantityInput.previousElementSibling &&
    quantityInput.previousElementSibling.classList.contains("product-quantity")
  ) {
    quantity.value = quantityInput.previousElementSibling.value;
  } else if (
    quantityInput.nextElementSibling &&
    quantityInput.nextElementSibling.classList.contains("product-quantity")
  ) {
    quantity.value = quantityInput.nextElementSibling.value;
  }

  const linePrice = price * quantity.value;

  Array.prototype.forEach.call(productRow.getElementsByClassName("product-line-price"), (e) => {
