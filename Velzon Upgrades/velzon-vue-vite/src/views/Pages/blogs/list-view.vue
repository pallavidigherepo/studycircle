...
<template>
    <Layout>
        <PageHeader title="List View" pageTitle="Blogs" />
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 05 Apr,
                                                ...
                                                451</span> | <a href="pages-profile.html"><i
                                                    class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">Minimalism is more than just a trend; it's a movement
                                            that continues to influence design worldwide. Learn how simplicity in design
                                            evolved and why it remains impactful today.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <a href="pages-blog-overview.html">
                                            <h5 class="fs-15 fw-semibold">Mastering User Experience Through Storytelling
                                            </h5>
                                        </a>
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 11 Feb,
                                                2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                                713</span> | <a href="pages-profile.html"><i
                                                    class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">Storytelling transforms user experiences by providing
                                            intuitive and engaging journeys. Discover how to integrate compelling
                                            narratives into UX design for maximum impact.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                                            <i class="ri-arrow-right-line"></i></a>
                                        <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 09
                                                July, 2024</span> | <span class="text-muted"><i
                                                    class="ri-eye-line me-1"></i> 479</span> | <a
                                                href="pages-profile.html"><i class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">In a world driven by trends, designing with purpose
                                            is key to creating meaningful work. Explore techniques to craft with
                                            intention and make every design count.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                                            <i class="ri-arrow-right-line"></i></a>
                                        <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 15 Sep,
                                                2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                                174</span> | <a href="pages-profile.html"><i
                                                    class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">Juggling creativity with deadlines can be a
                                            challenge. This post covers essential workflow tips and tools to keep your
                                            design process efficient and inspired.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                                            <i class="ri-arrow-right-line"></i></a>
                                        <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
                                            <a href="#!"
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 24 Oct,
                                                2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                                1926</span> | <a href="pages-profile.html"><i
                                                    class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">Every designer faces creative block at some point.
                                            Learn actionable strategies to break through these moments and find
                                            inspiration to fuel your next project.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                                            <i class="ri-arrow-right-line"></i></a>
                                        <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-xxl-9 col-lg-7">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                            <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 20
                                                Sept, 2024</span> | <span class="text-muted"><i
                                                    class="ri-eye-line me-1"></i> 1337</span> | <a
                                                href="pages-profile.html"><i class="ri-user-3-line me-1"></i> Admin</a>
                                        </div>
                                        <p class="text-muted mb-2">A strong brand identity is built on thoughtful
                                            design. Learn how to create cohesive visual stories that reflect your
                                            brand's values and connect with your audience.</p>
                                        <a href="pages-blog-overview.html" class="text-decoration-underline">Read more
                                            <i class="ri-arrow-right-line"></i></a>
                                        <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
