...
const dealsStatus = ref([
  {
    id: 1,
    name: "Absternet LLC",
    date: "Sep 20, 2021",
    img: new URL('@/assets/images/users/avatar-1.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    name: "Raitech Soft",
    date: "Sep 23, 2021",
    img: new URL('@/assets/images/users/avatar-2.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    name: "William PVT",
    date: "Sep 27, 2021",
    img: new URL('@/assets/images/users/avatar-3.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    name: "Loiusee LLP",
    date: "Sep 30, 2021",
    img: new URL('@/assets/images/users/avatar-4.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    name: "Apple Inc.",
    date: "Sep 30, 2021",
    img: new URL('@/assets/images/users/avatar-6.jpg', import.meta.url).href,
    representativeName: "Vitoria Rodrigues",
    badgeClass: "info",
    status: "New Lead",
    statusValue: "$78.9K",
