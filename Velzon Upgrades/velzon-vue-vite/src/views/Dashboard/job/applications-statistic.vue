...
const candidateList = ref([
  { id: 1, img: "@/assets/images/users/avatar-10.jpg", name: "Tonya Noble", username: "@tonya", designation: "Web Developer" },
  { id: 2, img: "@/assets/images/users/avatar-1.jpg", name: "Nicholas Ball", username: "@nicholas", designation: "Assistant / Store Keeper" },
  { id: 3, img: "@/assets/images/users/avatar-9.jpg", name: "Zynthia Marrow", username: "@zynthia", designation: "Full Stack Engineer" },
  { id: 4, img: "@/assets/images/users/avatar-2.jpg", name: "Cheryl Moore", username: "@cheryl", designation: "Product Designer" },
  { id: 5, img: "@/assets/images/users/avatar-5.jpg", name: "Jennifer Bailey", username: "@jennifer", designation: "Marketing Director" },
  { id: 6, img: "@/assets/images/users/avatar-8.jpg", name: "Hadley Leonard", username: "@hadley", designation: "Executive, HR Operations" },
]);

// Computed filtered list
const resultQuery = computed(() => {
  if (!searchQuery.value) return candidateList.value;
  const search = searchQuery.value.toLowerCase();
  return candidateList.value.filter(data =>
...
// Toggle button logic (ref to DOM manipulation)
onMounted(() => {
  const toggleBtns = document.getElementsByClassName("custom-toggle");
...
function showdetail(data) {
  const imgEl = document.getElementById("candidate-img");
  const nameEl = document.getElementById("candidate-name");
  const positionEl = document.getElementById("candidate-position");

  if (imgEl) imgEl.setAttribute("src", data.img);
  if (nameEl) nameEl.innerHTML = data.name;
  if (positionEl) positionEl.innerHTML = data.username;
}

// Chart data
const series = ref([
  { name: "New Application", data: [89, 56, 74, 98, 72, 38, 64, 46, 84, 58, 46, 49] },
  { name: "Interview", data: [45, 52, 38, 24, 33, 26, 21, 20, 6, 8, 15, 10] },
  { name: "Hired", data: [36, 42, 60, 42, 13, 18, 29, 37, 36, 51, 32, 35] },
]);
