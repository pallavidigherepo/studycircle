...
// Use `import.meta.glob` for better performance and optimization in Vite-based projects
const activeProjects = ref([
  {
    ...
    percentage: "53%",
    subItem: [
      { id: 1, assImg: "@/assets/images/users/avatar-1.jpg"},
      { id: 2, assImg: "@/assets/images/users/avatar-2.jpg"},
      { id: 3, assImg: "@/assets/images/users/avatar-3.jpg"},
    ],
    badge: "Inprogress",
    badgeClass: "warning",
    dueDate: "06 Sep 2021",
  },
  {
    ...
    percentage: "0%",
    subItem: [
      { id: 1, assImg: "@/assets/images/users/avatar-5.jpg"},
      { id: 2, assImg: "@/assets/images/users/avatar-6.jpg"},
    ],
    badge: "Pending",
    badgeClass: "danger",
    dueDate: "13 Nov 2021",
  ...
  },
  {
    ...
    percentage: "64%",
    subItem: [
      { id: 1, assImg: "@/assets/images/users/avatar-2.jpg"},
    ],
    badge: "Progress",
    badgeClass: "warning",
    dueDate: "15 Dec 2021",
  },
  {
    ...
    subItem: [
      { id: 1, assImg: "@/assets/images/users/avatar-1.jpg"},
      { id: 2, assImg: "@/assets/images/users/avatar-6.jpg"},
      { id: 3, assImg: "@/assets/images/users/avatar-4.jpg"},
    ],
    badge: "Progress",
    badgeClass: "warning",
    dueDate: "21 Dec 2021",
