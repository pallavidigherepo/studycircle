      ...
      <div class="table-responsive table-card">
        <table class="table align-middle table-borderless table-centered table-nowrap mb-0">
          <thead class="text-muted table-light">
            <tr>
              <th scope="col" style="width: 62px;">Active Page</th>
          ...
          <tbody>
            <tr>
              <td><BLink href="javascript:void(0);">/themesbrand/skote-25867</BLink></td>
              <td>99</td>
              <td>25.3%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/dashonic/chat-24518</BLink></td>
              <td>86</td>
              <td>22.7%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/skote/timeline-27391</BLink></td>
              <td>64</td>
              <td>18.7%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/themesbrand/minia-26441</BLink></td>
              <td>53</td>
              <td>14.2%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/dashon/dashboard-29873</BLink></td>
              <td>33</td>
              <td>12.6%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/doot/chats-29964</BLink></td>
              <td>20</td>
              <td>10.9%</td>
            </tr>
            <tr>
              <td><BLink href="javascript:void(0);">/steex/pages-29739</BLink></td>
              <td>10</td>
              <td>07.3%</td>
            </tr>
          </tbody>
