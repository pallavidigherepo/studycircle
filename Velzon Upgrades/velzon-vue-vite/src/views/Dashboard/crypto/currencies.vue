...
// Static imports for each crypto icon
import btcIcon from '@/assets/images/svg/crypto-icons/btc.svg'
import ltcIcon from '@/assets/images/svg/crypto-icons/ltc.svg'
import ethIcon from '@/assets/images/svg/crypto-icons/eth.svg'
import bnbIcon from '@/assets/images/svg/crypto-icons/bnb.svg'
import usdtIcon from '@/assets/images/svg/crypto-icons/usdt.svg'
import dashIcon from '@/assets/images/svg/crypto-icons/dash.svg'
import neoIcon from '@/assets/images/svg/crypto-icons/neo.svg'
import dogeIcon from '@/assets/images/svg/crypto-icons/doge.svg'
