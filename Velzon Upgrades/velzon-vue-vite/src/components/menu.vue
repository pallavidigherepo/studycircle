...
const onRoutechange = (path) => {
  initActiveMenu(path);
  const activeItems = document.getElementsByClassName("mm-active");
  if (activeItems.length > 0) {
    const currentPosition = activeItems[0].offsetTop;
    if (currentPosition > 500 && $refs.isSimplebar) {
      $refs.isSimplebar.value.getScrollElement().scrollTop = currentPosition + 300;
    }
  }
};
        ...
        <li class="nav-item">
          ...
          <div class="collapse menu-dropdown" id="sidebarForms">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <router-link to="/form/masks" class="nav-link" data-key="t.input.masks">{{ t("t.inputmasks") }}
                </router-link>
              </li>
              <li class="nav-item">
