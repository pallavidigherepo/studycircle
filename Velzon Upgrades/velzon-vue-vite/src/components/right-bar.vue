...
onBeforeMount(() => {
  ...
  localStorage.setItem("resetValue", JSON.stringify(layoutState))
})
...
const dataSidebarUserShow = ref(false);
...
const resetLayout = () => {
  ...
  layoutMethods.changeThemesColor({ themeColor: reset.themeColor });
};
...
const updateDocumentAttribute =(value) => {
  if (value) {
...
watch(layoutThemes, (newVal, oldVal) => {
  if (newVal !== oldVal) {
          switch (newVal) {
            case "default":
...
watch(dataSidebarUserShow, (newVal) => {
  updateDocumentAttribute(newVal)
});
        ...
        <div class="p-4">
            ...
            <BCol cols="6">
              <div class="form-check card-radio">
                <input id="customizer-theme09" name="data-theme" type="radio" value="interactive"
                  class="form-check-input" v-model="layoutThemes">
          ...
          <div id="body-img" v-if="layoutThemes == 'galaxy' ||
            ...
            <BRow>
              <BCol cols="4">
                <div class="form-check sidebar-setting card-radio">
                  <input class="form-check-input" v-model="bodybg" type="radio" name="data-body-image"
