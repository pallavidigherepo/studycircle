                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" type="button"
                                                class="material-shadow-none" id="button-addon1">Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" type="button"
                                                class="material-shadow-none" id="button-addon2">Button</BButton>
                                        </div>
                                    </BCol>
                                    <BCol lg="6">
                                        <div class="input-group">
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BButton variant="outline-primary" class="material-shadow-none">Button
                                            </BButton>
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            ...
                                            <BButton variant="outline-secondary" class="material-shadow-none">Button
                                            </BButton>
                                        </BInputGroup>
                                    </BCol>
                                </BRow>
                            ...
                            <div class="mt-4">
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" class="material-shadow-none"
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" class="material-shadow-none"
